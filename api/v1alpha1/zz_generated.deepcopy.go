...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EchoCondition) DeepCopyInto(out *EchoCondition) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EchoCondition.
func (in *EchoCondition) DeepCopy() *EchoCondition {
	if in == nil {
		return nil
	}
	out := new(EchoCondition)
	in.DeepCopyInto(out)
	return out
}
